...
<div class="bg-translucent p-10">
  <div class="login-box bg-white clearfix">
    ...
    <div class="login-right">
      <p><img src="<?php echo $skin;?>new/images/logo-sidebar.png" class="m-b-md m-t-xs" alt="logo"></p>
      <p class="text-white m-tb-15">万物互联，数据互通</p>
      <p class="text-white">Copyright © 2020 <a href="#">LaoJiang</a>. All right reserved</p>
    </div>
  </div>
</div>
