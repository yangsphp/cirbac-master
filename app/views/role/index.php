...
<div class="container-fluid p-t-15">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div id="toolbar2" class="toolbar-btn-action">
                        ...
                        <?php } ?>
                        <table id="produce_order_tab" style="text-align:center;word-break:break-all;"></table>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal fade" id="add_produce_order" tabindex="-1" role="dialog"
         aria-labelledby="add_produce_order_Label">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="add_produce_order_Label">新增角色</h4>
                </div>
    ...
    <script type="text/javascript">
        $('#produce_order_tab').bootstrapTable({
            ...
            columns: [
                {checkbox: true, width: '50px'}, {
                    ...
                    formatter: function (value, row, index) {
                        var pageSize = $('#produce_order_tab').bootstrapTable('getOptions').pageSize;     //通过table的#id 得到每页多少条
                        var pageNumber = $('#produce_order_tab').bootstrapTable('getOptions').pageNumber; //通过table的#id 得到当前第几页
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        if (result.code == 0) {
                            ...
                            $('#produce_order_tab').bootstrapTable('refresh');
        ...
        function selected_del() {
            var selRows = $('#produce_order_tab').bootstrapTable("getSelections");
            if (selRows.length == 0) {
